...
% SNR was defined as the difference between peak spectral amplitude and 
% fitted noise at that frequency, on the log scale, in units of dB.
power_corrected = log_power - fit_1f;

% find alpha peak
[pks, locs] = findpeaks(power_corrected, 'MinPeakProminence',0.5);
locs_alpha = intersect(locs, idx3);
peak_SNR = power_corrected(locs_alpha);%SNR peaks within alpha band
